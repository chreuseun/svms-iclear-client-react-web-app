                ...
                <Form>
                    <Form.Group widths='equal'>
                        ...
                        <DateInput
                            ...
                            placeholder="Date"
                            iconPosition="left"
                            onChange={ (event, {name, value}) => console.log('DateStart [day,month,year]: ', value.split('-'))}
                        />
                        ...
                        <DateInput
                            ...
                            placeholder="Date"
                            iconPosition="left"
                            onChange={ (event, {name, value}) => console.log('DateEnd [day,month,year]: ', value.split('-'))}
                        />
